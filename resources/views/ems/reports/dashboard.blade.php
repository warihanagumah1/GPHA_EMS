...
<div class="gpha-page-shell space-y-5">
    ...
    <section class="gpha-top-pipe rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div><h2 class="text-xl font-black text-slate-950">Generate Printable Report</h2><p class="font-semibold text-slate-500">Create a print-ready report for the selected operational period.</p></div>
