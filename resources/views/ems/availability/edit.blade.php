...
<div class="gpha-page-shell space-y-6">
    ...
    <section class="gpha-panel p-5"><form method="POST" action="{{ route('ems.availability.sessions.update',$session) }}" class="space-y-5">@csrf @method('PUT')
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <label><span class="gpha-label">Check Time <span class="text-red-600">*</span></span><input type="time" name="checked_at" value="{{ old('checked_at',substr($first->checked_at,0,5)) }}" min="00:00" max="23:59" step="60" class="gpha-input" required></label>
        </div>
