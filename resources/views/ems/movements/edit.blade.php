...
<div class="gpha-page-shell space-y-5">
    ...
    <section class="gpha-panel p-5"><x-ems.movement-form :ambulances="$ambulances" :locations="$locations" :movement="$dispatch" :action="route('ems.dispatches.update',$dispatch)" method="PUT" submit-label="Update Movement" /></section>
</div>
</x-app-layout>
