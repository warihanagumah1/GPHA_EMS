...
class Dispatch extends Model { use BelongsToActiveBranch, HasUuids; protected $guarded=[]; public function uniqueIds(): array{return ['uuid'];} public function ambulance(){return $this->belongsTo(Ambulance::class);} protected function casts(): array{return ['requested_at'=>'datetime','dispatched_at'=>'datetime','arrived_at'=>'datetime','completed_at'=>'datetime'];} public function getDistanceKmAttribute(): ?int{return $this->odometer_start!==null&&$this->odometer_end!==null ? $this->odometer_end-$this->odometer_start:null;} }
